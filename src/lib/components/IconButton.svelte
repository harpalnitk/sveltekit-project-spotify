...
// since focus called outside on this component will not work
//we need to expose the button inside this component
...
return button;
 ...
 <!-- focusable="false"  accessibility reasons for some browsers    -->
